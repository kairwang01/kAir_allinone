...
(function () {
  ...
  const I18N = {
    en: {
      ...
      "odera.idle": "Ask Odera anything…",
      "odera.thinking": "Odera is thinking…",
      "odera.ex1.prompt": "How did I sleep this week?",
      "odera.ex1.status": "Routed to Health · on-device",
      "odera.ex2.prompt": "Draft a kind reply to my landlord",
      "odera.ex2.status": "Routed to Chat · on-device",
      "odera.ex3.prompt": "Summarize this article in plain language",
      "odera.ex3.status": "Answered on-device",
    ...
    zh: {
      ...
      "hero.demo": "你想做什么？",
      "odera.idle": "问 Odera 任何事…",
      "odera.thinking": "Odera 正在思考…",
      "odera.ex1.prompt": "我这周睡得怎么样？",
      "odera.ex1.status": "已路由到健康 · 本地完成",
      "odera.ex2.prompt": "帮我给房东写一条客气的回复",
      "odera.ex2.status": "已路由到对话 · 本地完成",
      "odera.ex3.prompt": "用大白话帮我总结这篇文章",
      "odera.ex3.status": "已在本地作答",
